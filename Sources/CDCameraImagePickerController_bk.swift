//
//  CDCameraImagePickerController.swift
...
class CDCameraImagePickerController: UIViewController {
    ...
    lazy var noCameraButton: UIButton = { [unowned self] in
        ...
        let attributes = [NSAttributedString.Key.font: self.configuration.settingsFont,
    ...
    override func viewDidLoad() {
        ...
        [focusImageView, capturedImageView].forEach { view.addSubview($0) }
...
extension CDCameraImagePickerController: CameraDelegate {
